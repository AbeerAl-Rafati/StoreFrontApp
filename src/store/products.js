  ...
  products: [
    {
      ...
      description: "It is Plato's best-known work, and has proven to be one of the world's most influential works of philosophy and political theory, both intellectually and historically.[",
      price: 20,
      image:
    ...
    },
    {
      ...
      category: "Philosophy Books",
      description: "Kant explores human reason and then works to establish its illusions and get down to core constituents. ",
      price: 22,
      image:
    ...
    },
    {
      ...
      category: "Philosophy Books",
      description: "The Incoherence of the Philosophers is the title of a landmark 11th-century work by the Persian theologian Abū Ḥāmid Muḥammad ibn Muḥammad al-Ghazali and a student of the Asharite school of Islamic theology criticizing the Avicennian school of early Islamic philosophy.",
      price: 47,
      image:
    ...
    },
    {
      ...
      author: "H.G. Wells",
      category: "Historical Books",
      description: "Spanning the origins of the Earth to the outcome of the First World War, this is a brilliantly compelling account of the evolution of life and the development of the human race.",
      price: 77,
      image:
